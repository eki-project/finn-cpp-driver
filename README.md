...
* Building against Boost results in undefined references:
  * This issue is caused by namespaces leaking from inside XRT. The C++ driver has its own renamed (partial) boost version called finnBoost that can be used as a replacement.
