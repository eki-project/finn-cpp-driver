...
if(EXISTS ${XRT_INCDIR} AND EXISTS ${XRT_INCDIR_OCL})
  ...
  message(WARNING "XRT and OpenCL extensions not found")
  set(XRT_FOUND OFF)
...
cmake_path(GET LIBXRT_CORE_LIBRARY PARENT_PATH XRT_LIB_CORE_LOCATION)
cmake_path(GET LIBXRT_XILOCL_LIBRARY PARENT_PATH XRT_LIB_OCL_LOCATION)

message(STATUS "XRT_INCLUDE_DIRS = ${XRT_INCLUDE_DIRS}")
message(STATUS "XRT_LIBS         = ${XRT_LIBS}")
message(STATUS "XRT_LIB_CORE_LOCATION = ${XRT_LIB_CORE_LOCATION}")
message(STATUS "XRT_LIB_OCL_LOCATION = ${XRT_LIB_OCL_LOCATION}")
