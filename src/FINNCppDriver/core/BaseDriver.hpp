...
namespace Finn {
    ...
    class BaseDriver {
         ...
         * @param pConfig
         */
        BaseDriver(const Config& pConfig, uint hostBufferSize) : configuration(pConfig), logger(Logger::getLogger()) { accelerator = Accelerator(configuration.deviceWrappers, SynchronousInference, hostBufferSize); }
