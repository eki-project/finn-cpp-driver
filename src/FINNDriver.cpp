...
#undef NDEBUG
    ...
    */
    ...
    // // Shape data
    // Finn::shapeNormal_t myShape = std::vector<unsigned int>{1, 300};
    // Finn::shapeFolded_t myShapeFolded = std::vector<unsigned int>{1, 10, 30};
    // Finn::shapePacked_t myShapePacked = std::vector<unsigned int>{1, 10, 8};

    // Finn::shapeNormal_t oMyShape = std::vector<unsigned int>{1, 10};
    // Finn::shapeFolded_t oMyShapeFolded = std::vector<unsigned int>{1, 10, 1};
    // Finn::shapePacked_t oMyShapePacked = std::vector<unsigned int>{1, 10, 1};
    ...
    // auto data = std::vector<uint8_t>(mydb.size(Finn::SIZE_SPECIFIER::ELEMENTS_PER_PART));
