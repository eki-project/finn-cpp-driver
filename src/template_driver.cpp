...
int main() {
    ...
    DeviceHandler<int> dha = DeviceHandler<int>(deviceIndex, binaryFile, driverExecutionMode, INPUT_BYTEWIDTH, OUTPUT_BYTEWIDTH, ISHAPE_PACKED, OSHAPE_PACKED, SHAPE_TYPE::PACKED, SHAPE_TYPE::PACKED);
